...
//                return ServiceResponse("Empty comment", 400)
            ...
            val listing = datastore.retrieveListing(listingId) ?: return ServiceResponse("Listing not found", 4040)
...
//                return ServiceResponse("Empty comment", 400)
            val id = datastore.storeComment(comment.copy(creationDate = Date()))
            val user = datastore.retrieveUser(userId) ?: return ServiceResponse("User not found", 4040)
    ...
    public val users = object : UserService {
        ...
        override fun getUser(id: Int): ServiceResponse = ServiceResponse(datastore.retrieveUser(id)!!)
